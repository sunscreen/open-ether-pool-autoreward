...
var rewardinfo[10][10]int
var blockh int
var i int

const minDepth = 16
var byzantiumHardForkHeight int64
...
func (u *BlockUnlocker) setCoinReward() {
var forkh int
var hmsReward int
var byzReward int


    retblock, err := u.rpc.GetCurrentBlockHeight()
    if err != nil {
	u.halt = true
	u.lastFail = err
...
var retblocki=int(retblock)
forkh=getNextEpoch(retblocki)
byzantiumHardForkHeight = int64(forkh);


byzReward = getEpochNextReward(retblocki)
hmsReward = getEpochReward(retblocki)

homesteadReward = big.NewInt(int64(hmsReward))
byzantiumReward  = big.NewInt(int64(byzReward))

log.Printf("auto reward: Current block is %v Current Reward: %v Next Epoc block: %v next reward: %v  \n",retblock,homesteadReward,forkh,byzantiumReward)
...
func getEpochinfo(curEpoch int) []int {


rewardinfo[0][0]=1200000
rewardinfo[0][1]=2200000
rewardinfo[0][2]=3200000
rewardinfo[0][3]=4200000
rewardinfo[0][4]=5200000
rewardinfo[0][5]=6200000
rewardinfo[0][6]=7200000
rewardinfo[0][7]=8200000
rewardinfo[0][8]=10200000
rewardinfo[0][9]=12200000



rewardinfo[1][0]=6000000000000000000
rewardinfo[1][1]=5500000000000000000
rewardinfo[1][2]=5000000000000000000
rewardinfo[1][3]=4500000000000000000
rewardinfo[1][4]=4000000000000000000
rewardinfo[1][5]=3800000000000000000
rewardinfo[1][6]=3600000000000000000
rewardinfo[1][7]=3400000000000000000
rewardinfo[1][8]=3200000000000000000
rewardinfo[1][9]=3000000000000000000
//fmt.Println("2d: ", rewardinfo)


blockh=curEpoch

//for i := 0; i < 9; i++ {
//fmt.Printf("blockheight: %v reward: %v\n",rewardinfo[0][i],rewardinfo[1][i])

//}


//fmt.Printf("test blockheight is 1250000\n")


for i := 0; i < 9; i++ {

if (blockh >= rewardinfo[0][i]) {
//fmt.Printf("Current is %v blockheight: %v reward: %v\n",i+1,rewardinfo[0][i],rewardinfo[1][i])
//fmt.Printf("Next Epoc is %v blockheight: %v reward: %v\n",i+2,rewardinfo[0][i+1],rewardinfo[1][i+1])
break
}

}
tst := []int {rewardinfo[0][i+1],rewardinfo[1][i],rewardinfo[1][i+1]}
return tst
}
